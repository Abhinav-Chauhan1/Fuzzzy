    ...
    <>
      <div className="min-w-full h-screen flex justify-center items-center">
        <div className="absolute w-[80%] h-[80%] flex">
          {/* Section1 */}
          <div data-theme="light" className="relative md:w-[35%] m-auto  h-full max-md:p-10 bg-white max-md:rounded-3xl rounded-l-3xl
          flex justify-center max-md:overflow-auto">
            {/* Form */}
              <form className="flex flex-col pt-3 my-auto md:pt-8" onSubmit={handelSubmit}>
